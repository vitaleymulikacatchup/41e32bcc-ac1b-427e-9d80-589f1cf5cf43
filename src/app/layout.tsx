...
export const metadata: Metadata = {
  title: "F1 Motors - Next Generation Formula 1 Vehicles 2025",
  description: "Experience the pinnacle of F1 engineering with our 2025 championship-winning vehicle lineup. High-performance, precision-engineered automobiles.",
  keywords: "Formula 1, F1 cars, racing vehicles, high performance, motorsport, championship",
  metadataBase: new URL("https://f1motors.com"),
  alternates: {
    canonical: "https://f1motors.com"
  },
  openGraph: {
    title: "F1 Motors - Next Generation Formula 1 2025",
    description: "Introducing revolutionary F1 vehicles with advanced hybrid power systems and cutting-edge aerodynamic technology.",
    url: "https://f1motors.com",
    siteName: "F1 Motors",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1765895045857-j1ybnce8.jpg",
        alt: "F1 Motors flagship vehicle"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "F1 Motors - Championship-Winning Vehicles",
    description: "Next generation Formula 1 technology and performance.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1765895047053-xuphpqu2.jpg"]
  },
  robots: {
    index: true,
    follow: true
